...
class Customer: 
    ...
    # it deducts the amount from the customer wallet and calls the receive_payment method on the cashier object
...
class Stall:
    ...
    def has_item(self, name, quantity):
        if name not in self.inventory.keys():
            ...
            if self.inventory[name] > quantity or self.inventory[name] == quantity:
                return True
            else:
                return False
...
class TestAllMethods(unittest.TestCase):
    ...
    def test_validate_order(self):
        ...
        case1 = Customer("John", 5)
        case1.validate_order(self.c1, self.s1, "Burger", 5)
        self.assertEqual(case1.wallet, 5)
        
		# case 2: test if the stall doesn't have enough food left in stock
        case2 = Customer("Jessica", 150)
        case2.validate_order(self.c1, self.s1, "Burger", 100)
        self.assertEqual(case2.wallet, 150)

		# case 3: check if the cashier can order item from that stall
        case3 = Customer("Greg", 200)
        cashier = Cashier("South", directory = [self.s1])
        case3.validate_order(cashier, self.s2, "Burger", 2)
        self.assertEqual(case3.wallet, 200)
        

    # Test if a customer can add money to their wallet
    def test_reload_money(self):
        customer = Customer("Ethan", 50)
        customer.reload_money(20)
        self.assertEqual(customer.wallet, 50 + 20)
